...
1. **The Prompt** : Error Message - "(venv) ... RuntimeError: The current Flask app is not registered with this 'SQLAlchemy' instance. Did you forget to call 'init_app'..."
...
2. **The Prompt**: Error Message - "(venv) ... RuntimeError: The current Flask app is not registered with this 'SQLAlchemy' instance. (Repeat Error)"
...
3. **The Prompt**: "jinja2.exceptions.TemplateNotFound: index.html"
